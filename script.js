const fortunes = [
  ...
  // ✅ Extra 5 NEW Unique Quotes:
  "🌐 The next era of technology is being coded by you—line by line!",
  "📱 One app, one idea, one impact—start building today.",
  "🧩 Complex problems are puzzles waiting for your brilliant solution.",
  "💾 Every saved file is a chapter in your innovation journey.",
  "🧠 AI is just logic and vision—both of which you already have!"
];

const btn = document.getElementById("openCookie");
...
btn.addEventListener("click", function () {
  if (!isCracked) {
    ...
    msg.innerText = fortunes[randomIndex];
    btn.innerText = "Reset Cookie";
    isCracked = true;
  } else {
    msg.innerText = "Click the cookie to get your fortune!";
    btn.innerText = "Break a Cookie";
    isCracked = false;
  }
});
